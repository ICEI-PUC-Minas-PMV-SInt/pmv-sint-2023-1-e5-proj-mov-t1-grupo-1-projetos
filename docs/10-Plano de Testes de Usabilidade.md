...
<table>
	...
	<tr>
		<td>CT 5</td>
		<td>(Administrador)  Editar a ficha de um aluno específico</td>
		<td>
			<ul>
				<li> Na tela inicial, clicar na opção "Educando cadastrados"</li>
				<li>Selecionar o aluno específico dentre a lista de educandos cadastrados</li>
				<li>Vizualizar ficha do aluno</li>
				<li>Editar informações contidas na ficha do aluno</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		<td>CT 6</td>
		<td>(Administrador)  Deletar a ficha de um aluno específico</td>
		<td>
			<ul>
				<li> Na tela inicial, clicar na opção "Educando cadastrados"</li>
				<li>Selecionar o aluno específico dentre a lista de educandos cadastrados</li>
				<li>Vizualizar ficha do aluno</li>
				<li>Deletar a ficha do aluno</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		<td>CT 7</td>
		<td>(Administrador) Fazer cadastro de nova atividade</td>
		<td>
			<ul>
				<li>Na tela inicial, clicar na opção "Cadastrar Atividade"</li>
				<li>Preencher formulário e clicar no botão "Cadastrar Atividade"</li>
			</ul>
		</td>
		<td/>
	</tr>
	...
	<tr>
		<td>CT 9</td>
		<td>(Administrador)  Editar a ficha de uma atividade específica</td>
		<td>
			<ul>
				<li> Na tela inicial, clicar na opção "Atividades Cadastradas"</li>
				<li>Selecionar a atividade específica dentre a lista de atividades cadastradas</li>
				<li>Vizualizar ficha da atividade</li>
				<li>Editar informações contidas na ficha da atividade</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		<td>CT 10</td>
		<td>(Administrador)  Deletar a ficha de uma atividade específica</td>
		<td>
			<ul>
				<li> Na tela inicial, clicar na opção "Atividades Cadastradas"</li>
				<li>Selecionar a atividade específica dentre a lista de atividades cadastradas</li>
				<li>Vizualizar ficha da atividade</li>
				<li>Deletar a ficha da atividade</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		...
		<td>
			<ul>
				...
				<li>Preencher formulário e clicar no botão "Cadastrar Turma"</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		...
		<td>
			<ul>
				...
				<li>Escrever nome da turma no mecanismo de pesquisa </li>
				<li>Vizualizar ficha da turma</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		...
		<td>
			<ul>
				<li> Na tela inicial, clicar na opção "Turmas Cadastradas"</li>
				<li>Selecionar a turma específica dentre a lista de turmas cadastradas</li>
				<li>Vizualizar ficha da turma</li>
				<li>Editar informações contidas na ficha da turma</li>
			</ul>
		</td>
		<td/>
	</tr>
	<tr>
		...
		<td>
			<ul>
				<li> Na tela inicial, clicar na opção "Turmas Cadastradas"</li>
				<li>Selecionar a atividade específica dentre a lista de turmas cadastradas</li>
				<li>Vizualizar ficha da turma</li>
				<li>Deletar a ficha da turma</li>
			</ul>
		</td>
		<td/>
	</tr>
